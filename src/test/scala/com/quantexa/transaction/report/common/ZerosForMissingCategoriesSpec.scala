...
class ZerosForMissingCategoriesSpec extends AnyFlatSpec with Matchers {
  ...
  "generate" should "generate empty data for all accounts and categories" in {
    val data = List (
    ...
    val fillerWithZerosForAllCategories = ListMap(
      ("A1", "AA") -> 0.0, ("A1", "BB") -> 0.0, ("A1", "CC") -> 0.0, ("A1", "DD") -> 0.0, ("A1", "EE") -> 0.0, ("A1", "FF") -> 0.0, ("A1", "GG") -> 0.0,
      ("A2", "AA") -> 0.0, ("A2", "BB") -> 0.0, ("A2", "CC") -> 0.0, ("A2", "DD") -> 0.0, ("A2", "EE") -> 0.0, ("A2", "FF") -> 0.0, ("A2", "GG") -> 0.0
    )

    generate(data) shouldBe fillerWithZerosForAllCategories
